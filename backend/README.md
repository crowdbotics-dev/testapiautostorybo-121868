...
## Project Structure
    ...
    ├── testapiautostorybo_121868  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_121868`
...
2. Clone this repo and `cd testapiautostorybo_121868`
